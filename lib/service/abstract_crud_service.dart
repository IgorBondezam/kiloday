...
abstract class AbstractCrudService<T> {
  ...
  Future<List<T>> findAll() async {
    http.Response retorno = await http.get((Uri.parse('$url/${getComplemento()}')));
  ...
  Future<T> findById(int id) async {
    http.Response retorno = await http.get((Uri.parse('$url/${getComplemento()}/$id')));
    Map<String, dynamic> data = jsonDecode(retorno.body);
    return getInstance(data);
  }

  Future<void> save(Map<String, dynamic> body) async {
    http.Response response = await http.post((Uri.parse('$url/${getComplemento()}')), body: jsonEncode(body));
  ...
  Future<void> update(int id, T body) async {
    http.Response response = await http.put((Uri.parse('$url/${getComplemento()}/$id')), body: jsonEncode(body));
  ...
  Future<void> delete(int id) async {
     http.Response response = await http.delete((Uri.parse('$url/${getComplemento()}/$id')));
